...
1. Check cart amount Could to do
2. Check cart content Must to do
3. Purchase products by quantity Could to do
4. Get the New Collection Could to do
5. Footer And networks Could to do
6. Search function Could to do
7. Get own cart at any time Could to do
8. Get own total at any time Could to do
9. offers and season products Could to do
10. View an individual item details Must to do 
11. Checkout details 
12. Checkout Email details Must to do
13. Payment details Must to do 
14. Recipe Details Could to do 
15. Email confirmation Must to do 
...
16. Add a product Could to do
17. Delete product Could to do 
18. Edit/Update product Could to do 
19. Add a category Must to do 
20. Delete category Must to do 
21. Edit/update category Must to do 
